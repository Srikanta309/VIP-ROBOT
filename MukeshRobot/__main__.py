...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/secret_societ"),
    ],
    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"@Me_johnny_deep"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://github.com/srikanta309/VIP-ROBOT",
                        ),
                    ],
                    [
...
╔═════ஜ۩۞۩ஜ═════╗
  ...
  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𓆩𝐒𝐫𝐢𝐤𝐚𝐧𝐭𝐚𓆪](@Me_johnny_deep)♨️
